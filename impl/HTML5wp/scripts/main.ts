...
{
    var res: string = null;
    if (res == null) res = hoare.checkMethod(GammaNew, p.main, new VerificationFormulaGradual("true"), new VerificationFormulaGradual("true")).map(x => x.error).filter(x => x != null)[0];
