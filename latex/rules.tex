...
\AxiomC{}
\rlabel{WF-Var}
\UnaryInfC{$A_s \sfrme x$}
\end{prooftree}\hfill

\begin{prooftree}
\AxiomC{}
\rlabel{WF-Value}
\UnaryInfC{$A_s \sfrme v$}
\end{prooftree}\hfill

\begin{prooftree}
\AxiomC{$(x, f) \in A_s$}
\rlabel{WF-Field}
\UnaryInfC{$A_s \sfrme x.f$}
\end{prooftree}\hfill
...
\AxiomC{}
\rlabel{WF-True}
\UnaryInfC{$A_s \sfrmphi \true$}
\end{prooftree}\hfill

\begin{prooftree}
\AxiomC{$A_s \sfrme e_1$}
\AxiomC{$A_s \sfrme e_2$}
\rlabel{WF-Equal}
\BinaryInfC{$A_s \sfrmphi e_1 = e_2$}
\end{prooftree}\hfill
...
\AxiomC{$A_s \sfrme e_2$}
\rlabel{WF-NEqual}
\BinaryInfC{$A_s \sfrmphi e_1 \neq e_2$}
\end{prooftree}\hfill

\begin{prooftree}
\AxiomC{}
\rlabel{WF-Acc}
\UnaryInfC{$A_s \sfrmphi \acc(x.f)$}
\end{prooftree}\hfill
