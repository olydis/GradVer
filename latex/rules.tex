...
\subsubsection{No liftable composition for HSec - tictating runtime semantics}
...
\begin{description}
	...
	\end{mathpar}
	Note that the only reasonable definition of $env \vdash \withqm{\phi}$ is $env \vdash \phi$ since there is no further meaning to \qm~ as soon as it is being evaluated.
	...
	% nooope, need (some) framing of \text{goal}(s)
