...
{\phi_1 \implies \phi_2}
{\phi_1 ~\widetilde{\implies}~ \widetilde{\phi_2}}
\end{mathpar}
...
In fact it's pretty complicated, but maybe not necessary with smarter hoare rules?
