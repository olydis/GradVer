...
Lemma phiContainsAccessNot : forall p H r A o f,
...
Lemma phiContainsAccessHelperSfrme : forall x f A e,
  ¬ In (x, f) A ->
  xdotInE e x f ->
  sfrme A e ->
  False.
...
Proof.
  ...
  - eexists; split; eauto.
    destruct x1; inversionx H4; try tauto.
    inversionx H2.
    rewrite H1.
    intuition.
  - destruct x0; try inversionx H3.
    ...
    destruct v0; try inversionx H3; try tauto.
    inversionx H2.
    split; intuition.
    eexists; split; eauto.
    simpl.
...
Proof.
  ...
  - (*contradiction!*)
    ...
    eapply phiContainsAccessHelperSfrme in H1; eauto;
    tauto.
  - apply in_app_iff.
